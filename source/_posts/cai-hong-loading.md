...
.rainbow-arc:nth-child(2) .rainbow-arc-main {
  border-color: hsla(30, 100%, 60%, 0.8);
  height: 180px;
  width: 180px;
  top: 20px;
}
.rainbow-arc:nth-child(3) .rainbow-arc-main {
  border-color: hsla(60, 100%, 60%, 0.8);
  height: 160px;
  width: 160px;
  top: 30px;
}
.rainbow-arc:nth-child(4) .rainbow-arc-main {
  border-color: hsla(90, 100%, 60%, 0.8);
  height: 140px;
  width: 140px;
  top: 40px;
}
...
.rainbow-arc:nth-child(6) .rainbow-arc-main {
  border-color: hsla(150, 100%, 60%, 0.8);
  height: 100px;
  width: 100px;
  top: 60px;
}
.rainbow-arc:nth-child(7) .rainbow-arc-main {
  border-color: hsla(180, 100%, 60%, 0.8);
  height: 80px;
  width: 80px;
  top: 70px;
}
